...
class Dataset_Custom(Dataset):
    ...
    def __read_folder__(self):
        files_list = list(os.listdir(self.root_path))
        self.__read_file(os.path.join(self.root_path,
                                          files_list[self._file_idx]))
    ...
    def __read_data__(self):
        ...
        if self.data_path == ".":
            ...
            self._file_idx = 0
            self.__read_folder__()
        else:
            self.__read_file(os.path.join(self.root_path, self.data_path))
...
# class Dataset_Vital(IterableDataset):
#     def __init__(self, root_path, time_embed_path, flag='train', size=None, data_path='ETTh1.csv',
#                  scale=True, seasonal_patterns=None, drop_short=False):
#         self.seq_len = size[0]
#         self.label_len = size[1]
